...
SELECT * FROM employee
WHERE FirstName = 'Aleksanar'
--staveno e Aleksandar plus bidejki Antonio nemame 
...
SELECT * FROM employee
WHERE HireDate BETWEEN '01.01.1988' AND '01.25.1988' 

SELECT * FROM employee
WHERE LastName LIKE 'J%' AND HireDate BETWEEN '01.01.1988' AND '01.25.1988' 
